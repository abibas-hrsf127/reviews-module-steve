docker build -t reviewsfecserver .
docker run -d -p 3003:3003 --name reviewscontainer reviewsfecserver
docker run -d -p 2000:8080 -v $(pwd):/src/app --name psychic_reviewscontainer reviewsfecserver
